...
import { Trophy, Sparkles, Terminal, X, Check, ShieldCheck } from 'lucide-react';
...
export default function SecretAchievementModal({ isOpen, onClose }) {
  ...
  const copySecretCommand = () => {
    navigator.clipboard.writeText('sudo hire-neox --full-power --level=senior');
    setCopied(true);
        ...
        <div style={{
          ...
          <motion.div
            ...
            style={{
              ...
              borderRadius: '24px',
              padding: '24px',
              boxShadow: '0 25px 60px rgba(16, 185, 129, 0.35), 0 0 30px rgba(56, 189, 248, 0.2)',
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: '16px' }}>
              ...
              >
                <Trophy size={32} color="var(--emerald-main)" />
              </motion.div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--text-muted)', marginBottom: '8px', fontSize: '0.72rem' }}>
                ...
                <span>Nivel de Acceso: Root / Secret Admin</span>
              </div>

              <div style={{ color: 'var(--text-primary)', display: 'flex', alignItems: 'center', gap: '8px', wordBreak: 'break-all' }}>
                <span style={{ color: 'var(--emerald-main)', fontWeight: '700' }}>neox@devops:~$</span>
                <span style={{ color: 'var(--cyan-main)' }}>sudo hire-neox --full-power</span>
              </div>
            </div>
